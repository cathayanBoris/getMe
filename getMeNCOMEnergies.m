function [EKE,EPE] = getMeNCOMEnergies(NCOMinput)
...
% EKE calculation
u500a = u500 - nanmean(u500,3); v500a = v500 - nanmean(v500);
u300a = u300 - nanmean(u300,3); v300a = v300 - nanmean(v300);
u100a = u100 - nanmean(u100,3); v100a = v100 - nanmean(v100);
